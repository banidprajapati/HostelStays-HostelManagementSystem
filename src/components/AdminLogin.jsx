...
//   const handleLogin = () => {
//     if (email && password) {
//       // Perform login logic here (not implemented for simplicity)
...
//   const handleLogin = () => {
//     if (email && password) {
//       // Simulating login logic with a timeout
//       setTimeout(() => {
//         setShowSuccess(true);
...
const AdminLogin = () => {
  ...
  const handleLogin = () => {
    if (!email || !password) {
      setShowError(true);
    } else if (email === "karkiaayush901@gmail.com" && password === "Helloworld") {
      setShowSuccess(true);
    } else {
      setShowError(true);
    }
