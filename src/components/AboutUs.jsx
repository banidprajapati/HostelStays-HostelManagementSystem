        ...
        <div className="mt-7 mb-4 flex text-left gap-9">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 w-64">
              ...
              sustainable and enriching travel experiences in Nepal. We envision
              a future where travelers can immerse themselves in authentic cultural
              exchanges, support local economies, and contribute to environmental
              conservation efforts while exploring the beauty of Nepal.
            </p>
          </div>
        </div>
      </div>
