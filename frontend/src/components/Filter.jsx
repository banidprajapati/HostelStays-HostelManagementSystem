  ...
  return (
    <div className="bg-gray-200 w-72 text-left p-4">
      <div>
        ...
        <p className="mb-2">
          Popular locations in <br /> Kathmandu, Bagmati, Nepal
        </p>
        <h2 className="text-lg font-bold ">Prices</h2>
        <p className="font-bold text-sm mt-2">Estimated Cost (Nightly)</p>
        ...
        <div className="space-y-2 flex flex-col">
          <Checkbox name="type" colorScheme="green" borderColor="gray.400">
            Spa
          </Checkbox>
          <Checkbox name="type" colorScheme="green" borderColor="gray.400">
            TV
